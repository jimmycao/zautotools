...
#define false 0
   ...
   */
extern int opal_argv_append(int *argc, char ***argv, const char *arg);
   ...
   */
extern  int opal_argv_append_nosize(char ***argv, const char *arg);
 ...
 * @retval OPAL_ERROR On failure
 */
extern int opal_argv_prepend_nosize(char ***argv, const char *arg);
 ...
 */
extern  int opal_argv_append_unique_nosize(char ***argv, const char *arg, bool overwrite);
...
/**
   ...
   * array.
   */
extern  void opal_argv_free(char **argv);
   ...
   */
extern  char **opal_argv_split(const char *src_string, int delimiter) ;
   ...
   * without invalidating the output argv).
   */
extern  char **opal_argv_split_with_empty(const char *src_string, int delimiter) ;
   ...
   */
extern  int opal_argv_count(char **argv);
   ...
   */
extern  char *opal_argv_join(char **argv, int delimiter) ;

extern  char *opal_argv_join_range(char **argv, size_t start, size_t end, int delimiter) ;
   ...
   */
extern  size_t opal_argv_len(char **argv);
   ...
   */
extern  char **opal_argv_copy(char **argv);
     ...
     */
extern  int opal_argv_delete(int *argc, char ***argv,
     ...
     * target).
     */
extern  int opal_argv_insert(char ***target, int start, char **source);
 ...
 * target).
 */
extern  int opal_argv_insert_element(char ***target, int location, char *source);
